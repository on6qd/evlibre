...
public class AuthorizeUseCaseV201 implements AuthorizePort {

    private static final Logger log = LoggerFactory.getLogger(AuthorizeUseCaseV201.class);

    private final AuthorizationRepositoryPort authorizationRepository;
    private final TransactionRepositoryPort transactionRepository;
    private final TimeProvider timeProvider;

    public AuthorizeUseCaseV201(AuthorizationRepositoryPort authorizationRepository) {
        this(authorizationRepository, null, Instant::now);
    }

    public AuthorizeUseCaseV201(AuthorizationRepositoryPort authorizationRepository, TimeProvider timeProvider) {
