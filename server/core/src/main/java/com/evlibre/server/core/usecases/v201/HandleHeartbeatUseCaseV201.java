...
public class HandleHeartbeatUseCaseV201 implements HandleHeartbeatPort {

    private static final Logger log = LoggerFactory.getLogger(HandleHeartbeatUseCaseV201.class);

    private final StationRepositoryPort stationRepository;
    private final TimeProvider timeProvider;
    private final StationEventPublisher stationEventPublisher;

    public HandleHeartbeatUseCaseV201(StationRepositoryPort stationRepository,
