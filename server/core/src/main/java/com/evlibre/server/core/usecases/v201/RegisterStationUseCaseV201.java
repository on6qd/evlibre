...
import com.evlibre.server.core.domain.v201.ports.inbound.RegisterStationPort;
...
public class RegisterStationUseCaseV201 implements RegisterStationPort {

    private static final Logger log = LoggerFactory.getLogger(RegisterStationUseCaseV201.class);
    ...
    public RegisterStationUseCaseV201(TenantRepositoryPort tenantRepository,
